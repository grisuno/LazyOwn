...
class CloudAttackCommandSet(LazyOwnCommandSet):
    ...
    def do_entra_attack(self, line: str) -> None:
        ...
        if method == "device_code":
            ...
            self._cmd.poutput("    Scopes requested:")
            ...
            self._cmd.poutput("    Requirements:")
            ...
            self._cmd.poutput("    IMDS Endpoints:")
            ...
            for _name, endpoint in result["graph_endpoints"].items():
    ...
    def do_aws_privesc(self, line: str) -> None:
        ...
        """
        from modules.aws_attacks import AWS_PRIVESC_METHODS, AWSAttackEngine
