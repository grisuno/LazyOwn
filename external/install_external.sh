...
download() {
    ...
    commands=(
        ...
        "git clone https://github.com/arthaud/git-dumper.git .exploit/git-dumper"
        ...
        "git clone https://github.com/BloodHoundAD/BloodHound.git .exploit/BloodHound"
        ...
        "git clone https://github.com/RaptorAttack/ADTools.git .exploit/ADT00lz"
        ...
        "git clone https://github.com/S3cur3Th1sSh1t/Creds.git .exploit/Creds"
        "git clone https://github.com/Arvanaghi/SessionGopher.git .exploit/SessionGopher"
        "git clone https://github.com/cybersectroll/TrollRPC.git .exploit/TrollRPC"
        ...
        "git clone https://github.com/dagowda/Powershell_c-_hollowing.git .exploit/Powershell_c-_hollowing"
